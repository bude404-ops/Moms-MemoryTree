...
import { demoCostAssumptions, demoFamily, demoStorage, demoStorageAddons, demoStoragePlans, demoSubscription } from '../lib/demoData';
import type { MemoryMedia } from '../types/domain';

const economics = { storagePlans: demoStoragePlans, subscription: demoSubscription, storageAddons: demoStorageAddons, costAssumptions: demoCostAssumptions };
